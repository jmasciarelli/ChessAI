 ...
 * 
 * The Bishop is an extension of the abstract piece class. It has a unique set of rules
...
public class Bishop extends Piece {
    ...
    public Bishop(int[] loc, int player) {
        super(loc, player);
        
        name = player+"B"; //name is player num followed by P for pawn

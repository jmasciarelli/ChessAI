 ...
 * 
 * The Rook is an extension of the abstract piece class. It has a unique set of rules
...
public class Rook extends Piece {
    ...
    public Rook(int[] loc, int player) {
        super(loc, player);
        
        name = player+"R"; //name is player num followed by P for pawn
